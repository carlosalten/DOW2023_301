    ...
    <div class="col-12 col-md-6 col-lg-4 col-xl-2 mb-3">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="btn-group d-flex justify-content-center">
                    <a href="{{route('jugadores.index')}}" class="btn btn-outline-success">Ver</a>
                    <a href="{{route('jugadores.create')}}" class="btn btn-outline-success">Agregar</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-12 col-md-6 col-lg-4 col-xl-2 mb-3">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="btn-group d-flex justify-content-center">
                    <a href="{{route('partidos.index')}}" class="btn btn-outline-success">Ver</a>
                    <a href="{{route('partidos.create')}}" class="btn btn-outline-success">Agregar</a>
                </div>
            </div>
        </div>
    </div>
